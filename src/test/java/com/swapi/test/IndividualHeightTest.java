...
public class IndividualHeightTest extends TestBase {

	private Logger log = Logger.getLogger(IndividualHeightTest.class);
	String response = TestBase.base();

	@Test
	public void findNameWithHeightGreaterThan200() {
