...
@Test
	...
	public void findTotalPeople() {
		...
		// An arrayList to store People objects
			...
			int totalNumber =	person.size();		// Use the size method to get the total number of elements in the list
			int expectedNumber = 82;		// expected number
			assertEquals(totalNumber, expectedNumber);		// verify that the totalNumber and expectedNumber are equal
}
}
